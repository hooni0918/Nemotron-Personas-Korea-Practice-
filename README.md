...
|---|---|---|---|
| **[v4 (최신)](./results/2026-05-22_v4_real-interview-prep/SUMMARY.md)** | — (시뮬 새로 안 돌림) | **실사용자 인터뷰 진행 도구셋 준비** | 인터뷰 가이드·분석 템플릿·모집 가이드 3종. v5에서 실제 5~8명 인터뷰 후 시뮬 vs 실제 비교 |
| [v3](./results/2026-05-20_v3_nemotron-matched/SUMMARY.md) | Nemotron 풀에서 자동 추출한 120명 | 일반 사용자 베이스라인 확인 | MVP1 87.5% 만장일치. 그룹 기능은 마케팅 직군이 가장 강함 |

...
|---|---|---|---|---|---|
| **[v4](./2026-05-22_v4_real-interview-prep/SUMMARY.md)** | 2026-05-22 | 시뮬 새로 안 돌림. **실사용자 인터뷰 진행 도구셋 준비** | — (도구만) | — | 모집 가이드·인터뷰 스크립트·분석 템플릿 3종. v5에서 실제 5~8명 인터뷰 후 시뮬 vs 실제 비교판 생성 |
...
- 🟢 [**SUMMARY.md — v4 셋업 안내와 v5 흐름**](./2026-05-22_v4_real-interview-prep/SUMMARY.md)
- 📋 [**`interview_guide_v1.md`**](./2026-05-22_v4_real-interview-prep/interview_guide_v1.md) — 60~75분 인터뷰 스크립트 (Q1-Q20 매핑)
- 📝 [`analysis_template.md`](./2026-05-22_v4_real-interview-prep/analysis_template.md) — 인터뷰 후 빈칸 채우기 (시뮬 vs 실제)
- 👥 [`recruiting_guide.md`](./2026-05-22_v4_real-interview-prep/recruiting_guide.md) — 5~8명 모집 가이드
